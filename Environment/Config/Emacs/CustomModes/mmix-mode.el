;; mmix-mode.el --- major mode for editing MMIX code
...
(defcustom mmix-mode-syntax-table nil
  "Syntax table used while in MMIX mode.")
...
"
  ...
  (setq mode-name "MMIX")
  (setq major-mode 'mmix-mode)
  (setq local-abbrev-table mmix-mode-abbrev-table)
  ;; Font lock support
  (make-local-variable 'font-lock-defaults)
  (setq font-lock-defaults '(mmix-font-lock-keywords nil t))
  (make-local-variable 'mmix-mode-syntax-table)
  (setq mmix-mode-syntax-table (make-syntax-table))
  (set-syntax-table mmix-mode-syntax-table)
  (make-local-variable 'comment-end)
  (setq comment-end "")
  (make-local-variable 'comment-column)
  (setq comment-column 32)
  (setq fill-prefix "\t")
  (run-hooks 'mmix-mode-hook))
...
(defun mmix-line-matches (pattern &optional withcomment)
  (save-excursion
    (beginning-of-line)
    (looking-at pattern)))
